...
// description은 언어 이름을, note는 '진행도 설명 보기'를 누르면 표시됩니다.
export const classicalLanguageProgress = [
  {
    id: 'ancient-greek',
    name: '희랍어',
    description: '고대 그리스 세계에서 쓰인 언어입니다. 대략 기원전 9세기부터 기원후 6세기까지의 문헌에서 볼 수 있으며, 호메로스의 서사시와 아테네의 철학·역사·비극, 신약성서 같은 코이네 그리스어 문헌을 읽는 데 필요합니다.',
    level: 4,
  ...
  },
  {
    id: 'latin',
    name: '라티움어',
    description: '고대 로마에서 쓰인 언어로, 기원전 7세기 무렵부터 기록이 남아 있습니다. 로마 제국이 사라진 뒤에도 중세와 근대 유럽에서 학문·종교·외교의 공용 문어로 오랫동안 사용되어, 고대 문학부터 근대 학술서까지 폭넓은 원전을 읽는 데 쓰입니다.',
    level: 1,
    note: '2개월 독학',
  },
  {
    id: 'akkadian',
    name: '악카드어',
    description: '오늘날의 이라크를 중심으로 한 고대 메소포타미아에서 쓰인 언어입니다. 기원전 24세기 무렵부터 기원후 1세기 무렵까지 점토판에 쐐기문자로 기록되었으며, 바빌로니아와 아시리아의 편지·법전·행정문서와 「길가메시 서사시」 같은 작품을 읽는 데 필요합니다.',
    level: 3,
